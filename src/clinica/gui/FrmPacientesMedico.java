 ...
 * @author celso
 */
public class FrmPacientesMedico extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Controle de Pacientes Médicos");
        setPreferredSize(new java.awt.Dimension(1032, 611));
        ...
        txtOp1.setToolTipText("Informe o nome da operadora.");

        txtOp2.setToolTipText("Informe o nome da operadora.");
        ...
        btnFechar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/clinica/imagens/sair.png"))); // NOI18N
        btnFechar.setMnemonic('n');
        btnFechar.setText("Sair");
        btnFechar.setToolTipText("Cadastra novo paciente");
        ...
        btnNavFirst.setText("|<");
        btnNavFirst.setToolTipText("Primeiro registro");
        ...
        btnNavPrev.setText("<");
        btnNavPrev.setToolTipText("Registro anterior");
        ...
        btnNavNext.setText(">");
        btnNavNext.setToolTipText("Próximo registro");
        ...
        btnNavLast.setText(">|");
        btnNavLast.setToolTipText("Último registro");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(btnNavFirst)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnNavPrev)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnNavNext)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnNavLast)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnExcluir, btnFechar, btnNovo, btnSalvar});
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnExcluir, btnFechar, btnNovo, btnSalvar});
        ...
        if (!txtPesquisaPacienteMed.getText().isEmpty()) {
            ...
            if (Utils.soNumero(txtPesquisaPacienteMed.getText())) {
                ...
                if (txtPesquisaPacienteMed.getText().length() == 11) {
                    ...
                    PacienteMedicoDao pac = new PacienteMedicoDao();
                    ...
                    if (lista.size() == 1) {
                        ...
                        frb.recebePacienteMedico(this, lista);
                    } else {
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        // Variavel que recebera o indice que sera criado na insersao do novo paciente
        //int LastID;

        // Seta a variavel NovoPaciente para na hora de salvar saber que se trata de um paciente novo e executa um INSERT ao inves de um UPDATE
        ...
        // Habilita e desabilita botao de acao
        //btnSalvar.setEnabled(true);
        // btnEditar.setEnabled(false);
        //btnExcluir.setEnabled(false);
        //btnNovo.setEnabled(false);
        // Habilita campos para insersao de dados do paciente
        //HabilitarCampos();
        // Pega o ultimo paciente cadastrado e acresenta 1 para saber o numero do novo paciente
        /*
         PacienteMedicoDao pac = new PacienteMedicoDao();
         LastID = pac.BuscaNovoID();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (this.PacSelecionado != null) {
            if (JOptionPane.showConfirmDialog(this, "Deseja realmente excluir paciente " + PacSelecionado.getPacNome() + " do sistema?", "Excluir Paciente", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
                ...
                PacienteMedicoDao pacienteDao = new PacienteMedicoDao();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtNome.getText().equals("")) {
            ...
            PacienteMedicoDao pacDao = new PacienteMedicoDao();
    ...
    private void btnNavFirstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNavFirstActionPerformed
        PacienteMedicoDao pDao = new PacienteMedicoDao();
        recebeSelecionado(pDao.PrimeiroRegistro());
        /*
         PacienteMedicoDao pDao = new PacienteMedicoDao();
         recebeSelecionado(pDao.BuscaPaciente(1));
         */
    ...
    private void btnNavPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNavPrevActionPerformed
        if (this.PacSelecionado != null) {
            ...
            btnNavFirstActionPerformed(null);
        }
    ...
    private void btnNavNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNavNextActionPerformed
        ...
        if (this.PacSelecionado != null) {
            ...
            btnNavLastActionPerformed(null);
        }
